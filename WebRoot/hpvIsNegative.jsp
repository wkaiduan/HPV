...
<html>
  ...
  <body>
  	...
  	<div id="father" style="width:auto;margin:0px auto";>
       <table id="aaa" ></table>
    </div>
     <div id="btns">
  		<div >
  			名称:<input type="text" id="totale"><a href="javascript:search();" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">查询</a>
  		</div>
  	</div>
  </body>
</html>